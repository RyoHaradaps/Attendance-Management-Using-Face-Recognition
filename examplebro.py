...
class form:
    ...
    def generate_pdf(self):
        ...
        # Draw the first table on the PDF
        ...
        height_first_table = number_of_rows_first_table * 50
        ...
        if self.csv_data is not None:
            ...
            # Adjust the position of the CSV table based on the height of the first table
            y_position_csv_table = height - 320 - height_first_table
            table.wrapOn(c, 100, y_position_csv_table)
            table.drawOn(c, 100, y_position_csv_table)
